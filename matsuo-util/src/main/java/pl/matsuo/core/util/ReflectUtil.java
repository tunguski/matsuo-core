...
public class ReflectUtil {
  ...
  private static <E extends AccessibleObject> Try<Object> accessMember(Object object, String fieldName,
                                         EFunction<String, E> memberGetter, EBiFunction<E, Object, Object> valueGetter) {
    try {
  ...
  protected static <E> Try<Object> getValue(Object object, String fieldName, Class clazz) {
    if (!clazz.equals(Object.class)) {
      return ReflectUtil.<Field>accessMember(object, fieldName, clazz::getDeclaredField, Field::get).ifFailure(
              () -> ReflectUtil.<Method>accessMember(object, "get" + capitalize(fieldName), clazz::getDeclaredMethod, Method::invoke)
  ...
  public static <E> Class<E> getPropertyType(final Class<?> clazz, String fieldName) {
    ...
    for (String fieldPart : fieldName.split("[.]")) {
      ...
      if (exactType == null) {
        throw new RuntimeException("No such property/getter in class " + clazz.getSimpleName() + " for " + fieldName);
      }
    }
