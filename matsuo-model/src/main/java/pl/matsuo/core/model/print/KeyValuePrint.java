...
public class KeyValuePrint extends KeyValueEntity implements IFacadeAware {
  ...
  public static Supplier<? extends KeyValuePrint> print(Class<? extends IPrintFacade> clazz, Integer id) {
    return () -> printInitializer(clazz, id).apply(new KeyValuePrint());
  }


  public static <E extends KeyValuePrint> Function<E, E> printInitializer(Class<? extends IPrintFacade> clazz, Integer id) {
    return print -> {
