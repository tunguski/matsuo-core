...
public interface DatabaseMethods {
  ...
  default <E extends AbstractEntity> E findById(Class<E> clazz, Integer id, Initializer<E>... initializers) {
    return getDatabase().findById(clazz, id, initializers);
  };


  default <E extends AbstractEntity> List<E> findAll(Class<E> clazz, Initializer<E>... initializers) {
