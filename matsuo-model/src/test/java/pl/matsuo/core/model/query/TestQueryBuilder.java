...
public class TestQueryBuilder {
  ...
  public void testIlike1() throws Exception {
    assertEquals("lower(field) like '1%'", ilike(TheModel::getField, 1, MatchMode.START).print(abstractQuery));
    assertEquals("lower(field) like '%1'", ilike(TheModel::getField, 1, MatchMode.END).print(abstractQuery));
  }


  @Test
  public void testIn() throws Exception {
    assertEquals("field in (1, 2, 3)", in(TheModel::getField, asList(1, 2, 3)).print(abstractQuery));
  }


  @Test
  public void testIn1() throws Exception {
    assertEquals("field in (1, 2, 3)", in(TheModel::getField, new Object[] { 1, 2, 3 }).print(abstractQuery));
  }
  ...
  public void testEqOrIsNull() throws Exception {
    assertEquals("(field = 1 OR field IS NULL)", eqOrIsNull(TheModel::getField, 1).print(abstractQuery));
  }


  @Test
  public void testOr() throws Exception {
    assertEquals("(f1 = 1 OR f2 = 2)", or(eq(TheModel::getF1, 1), eq(TheModel::getF2, 2)).print(abstractQuery));
  }
