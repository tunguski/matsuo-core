...
@ContextConfiguration(
    classes = {
      DbConfig.class, TestDataExecutionConfig.class, FacadeBuilder.class,
      EntityInterceptorService.class, IdBucketInterceptor.class, TestSessionState.class,
      UserTestData.class
    })
public abstract class AbstractDbTest implements FacadeBuilderMethods {
