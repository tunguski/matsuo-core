...
public class PayersTestData extends AbstractMediqTestData {
  ...
  public void internalExecute() {
    ...
    createCompany(
        "Dell Company sp. z o.o.",
        DELL,
        "Warszawa",
        "Aleje Jerozolimskie 147",
        "6340194590",
        "003538527",
        "50100698500",
        "73020514008",
    ...
    createCompany(
        "PZU oddział terenowy Legionowo",
        PZU_LEG,
        "Legionowo",
        "Mrugacza",
        "5262222336",
  ...
  private OrganizationUnit createCompany(
    ...
    List<Person> employees =
        patientPesels.length > 0
            ? database.find(query(Person.class, in(Person::getPesel, patientPesels)))
