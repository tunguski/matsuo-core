...
public interface PrintMethods {
  ...
  default <E extends IPrintFacade<F>, F extends IPrintElementFacade> KeyValuePrint initializePrint(
      Class<E> printClass, Integer idEntity, Consumer<E> initializePrint,
  ...
  default <E extends IPrintFacade<F>, F extends IPrintElementFacade> E initializeFacade(
      Class<E> printClass, Integer idEntity, Consumer<E> initializePrint,
      Consumer<? super F> ... elementInitializations) {
    return getFacadeBuilder().createFacade(initializePrint(
        printClass, idEntity, initializePrint, elementInitializations), printClass);
  }
  ...
  default <E extends IPrintFacade<F>, F extends IPrintElementFacade, P extends KeyValuePrint> E initializeFacade(
      P print, Class<E> printClass, Consumer<E> initializePrint, Consumer<? super F> ... elementInitializations) {
    return getFacadeBuilder().createFacade(initializePrint(
        print, printClass, initializePrint, elementInitializations));
  }
}
